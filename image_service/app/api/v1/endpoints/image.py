...
async def create_image(file: UploadFile = File(...), image_service: ImageService = Depends(ImageService)):
    try:
        url = await image_service.create_image(file=file, user_id="asdasdsa")
        return url
